...
class AuthorListViewTest(TestCase):
  ...
  def setUpTestData(cls) -> None:
    ...
    Author.objects.bulk_create(
      [
        Author(first_name=f'Dominique {author_id}', last_name=f'Surname {author_id}') 
...
class LoanedBookInstancesByUserListViewTest(TestCase):
  ...
  def test_only_borrowed_book_in_list(self):
    ...
    # confirm books borrowed by testuser1 and on loan
...
class AuthorCreateViewTest(TestCase):
  ...
  def test_form_date_of_death_initially_2020_11_06(self):
    login = self.client.login(username='testuser2', password='2HJ1vRV0Z&3iD')
    response = self.client.get(reverse('author-create'))
    self.assertEqual(response.status_code, 200)

    initial_death = '2020-11-06'
    self.assertEqual(response.context['form'].initial['date_of_death'], initial_death)
